...
public class SiftDynamicMain {
    ...
    // Configuration
    // =======================
    private static final int VECTORS_TO_DELETE = 1000;
    private static final int FINAL_DELETES = 5000;
    ...
    private static final String BASE_PATH =
            "/Users/kartikeysrivastava/Desktop/projects/dataset/siftsmall-10k/";

    private static final String BASE_VECTORS = BASE_PATH + "siftsmall_base.fvecs";
    private static final String QUERY_VECTORS = BASE_PATH + "siftsmall_query.fvecs";
    private static final String GROUND_TRUTH = BASE_PATH + "siftsmall_groundtruth.ivecs";
